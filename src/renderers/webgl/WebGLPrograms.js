...
class WebGLPrograms {
	...
	constructor( renderer, cubemaps, extensions, capabilities, bindingStates, clipping ) {
		...
		/** @const */ this.isWebGL2 = capabilities.isWebGL2;
		/** @const */ this.logarithmicDepthBuffer = capabilities.logarithmicDepthBuffer;
		/** @const */ this.floatVertexTextures = capabilities.floatVertexTextures;
		/** @const */ this.maxVertexUniforms = capabilities.maxVertexUniforms;
		/** @const */ this.vertexTextures = capabilities.vertexTextures;

		this.precision = capabilities.precision;

		/** @const */ this.shaderIDs = {
